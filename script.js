...
you always make me feel happy.`
    ...
    first: {
        ...
        content: `We met through a screen, we were online together in the same time
        in the same game , map , server.
Yet somehow ,
...
I have hundreds of reasons to tell them.
But if I had to choose just one,
I’d say it’s the way you make me feel safe.`
    },
    memory: {
        title: "A Memory",
        content: `I remember the way
you always made me feel special, especially when we were children
 you always made me feel like I was the most important person in the world to you.
...
I’d end up getting disappointed.
like what was all that?`
    },
    knew: {
        title: "If You Knew",
        content: `Maybe you already know this…
        and u would definitely say [ye i know no need to say it lol]
but I’ll say it anyway again and again

You’re one of the kindest people
I’ve ever met, ur an amazing person.
u make me laugh u make me smile and I love the way you care about me
I just love the way you are with me :3
...
wish u the best year in ur 19 birthday!`
    },
    end: {
        title: "The End",
        content: `Thank you…
for making me feel loved,
even when I didnt know how to love u the same way
HAPPY BIRTHDAY ABOoooD ;33.`
    }
};
